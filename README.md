...
<br/>
<p >A custom <code>vite-react</code> template</p>
...
#### Framework
 ...
 - bootstraped by [vitejs](https://vitejs.dev/)
...
- [lodash-es](https://lodash.com/docs/4.17.15)
...
You can learn more in the [Vitejs](https://vitejs.dev/).
